class QuantcodeDev < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "3cb04c90a1094df7749ae1a5ae6b5a628fd5fbefb079a808020944fe9b7be5cf"
    end
  end
  ...
  on_linux do
    on_arm do
      ...
      sha256 "ec7c2c2c3198dd2d133f279f77d3a46bd375ad73e929fcd7265d64555f4966c7"
    end
    on_intel do
      url "https://github.com/quantcdn/quantcode-releases/releases/download/latest-dev/quantcode-dev-linux-x64.tar.gz"
      sha256 "583b028427e28996f6a983efc1112196a619bd2cb4fce09da73db49b1a7c7a18"
    end
  end
